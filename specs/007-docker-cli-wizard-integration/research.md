...
**Rationale**: The default is universally correct for wizard-initiated React deployments. The config-file path (`CARBORATOR_EC2_DEPLOY_DIR` env var) remains available for non-wizard users who need a custom directory.
